                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //descreption section
                      10.heightBox,
                      "Descreption".text.color(darkFontGrey).fontFamily(semibold).make(),
                      10.heightBox,
                      "This is a dummy item and dummy descreption here...".text.color(darkFontGrey).make(),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          ).box.white.margin(EdgeInsets.symmetric(horizontal: 4)).padding(EdgeInsets.all(8)).roundedSM.make()),
                        ),
                      )
                    ],
                )
